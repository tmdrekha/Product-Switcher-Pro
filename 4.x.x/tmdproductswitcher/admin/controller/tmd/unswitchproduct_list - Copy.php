...
class UnswitchProductList extends \Opencart\System\Engine\Controller {
	...
	protected function getList() {
		...
		$switchdatas = $this->model_extension_tmdproductswitcher_tmd_unswitchproduct_list->getProductswitchids();
		$productids  = 0;
		$productids = implode("','", $switchdatas);

		$product_total = $this->model_extension_tmdproductswitcher_tmd_unswitchproduct_list->getTotalProductSwitchers($productids,$filter_data);
		$results = $this->model_extension_tmdproductswitcher_tmd_unswitchproduct_list->getunSwitchProducts($productids,$filter_data);
